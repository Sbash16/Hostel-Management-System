        ...
        <div class="page-wrapper">
            ...
            <form method="POST">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        ...
                        <div class="card-body">
                                ...
                                <div class="custom-control custom-radio">
                                    ...
                                    <label class="custom-control-label" for="customRadio1">Required <code>Extra ₦3,000 Per Month</code></label>
                                </div>
                                <div class="custom-control custom-radio">
                ...
                <h4 class="card-title mt-5">Guardian's Information</h4>
                    ...
                    <h5 class="card-title mt-5">Please fill up the form "ONLY IF" you have a different permanent address!</h5>
                    ...
                    <div class="form-actions">
                        <div class="text-center">
                            <button type="submit" id="btn1" name="submit" class="btn btn-success">Submit</button>
                            <button type="reset" id="btn" class="btn btn-dark">Reset</button>
                        </div>
                    </div>
